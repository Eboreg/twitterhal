...
class RedisList(UserList):
    ...
    def __init__(self, redis: Redis, key: str, initlist: Union[List, UserList], overwrite: bool, **kwargs): ...
    def __new__(cls, redis: Redis, key: str, list_type: Optional[Type], pickle_protocol: int, **kwargs): ...
    @classmethod
